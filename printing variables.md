...
In this challenge we learn how to use env command which displays every exported variable set which is present in our shell.
...
PWD=/home/hacker
DOJO_AUTH_TOKEN=b8f43ad47b0a971de922ae043f1809955991f2c46c07f81a0e284e7a423abf49
HOME=/home/hacker
LANG=C.UTF-8
...
FLAG=pwn.college{IDujoPYEf-RfymKjtao0AYvhwvC.dhTN1QDL5MTM1czW}
...
_=/run/workspace/bin/envConnected!
hacker@variables~printing-exported-variables:~$ env
SHELL=/run/dojo/bin/bash
HOSTNAME=variables~printing-exported-variables
PWD=/home/hacker
